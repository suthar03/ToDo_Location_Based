...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        receiver = intent.getParcelableExtra(Statics.RECEIVER);
        double latitude = intent.getDoubleExtra(Statics.LOCATION_LAT_EXTRA, -1);
        double longitude = intent.getDoubleExtra(Statics.LOCATION_LNG_EXTRA, -1);
        String language = intent.getStringExtra(Statics.LANGUAGE);
